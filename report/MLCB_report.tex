...
\author{Giorgos Boulogeorgos, Andreas Mici \\[3pt]
\small MLCB Team Project --- Re-analysis of Maitra \textit{et al.}
...
by an interpretability and hypothesis-testing layer (Step~4). Each expensive step
is checkpointed so a runtime timeout never costs more than one step.
